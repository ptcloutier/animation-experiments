...
//  AnimationIsand
//
//  Created by Perrin Cloutier on 11/29/17.
...
class PCColors {
    ...
    class func getPsychedelicIceCreamShopColors()-> [UIColor] {
        ...
        let psyUIColors = [neonAqua, lightCoral, lightViolet, deepBlue, darkViolet, lightestBlueSky, brightCoral, medViolet, medViolet, deepBlueDark, medRose, lightViolet, darkRose, medRose, lighterBlueSky, medViolet, lighterBlue, lightBlueSky, lightRose, rose, deepBlueShade]
